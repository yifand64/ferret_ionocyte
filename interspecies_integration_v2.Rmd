...
```{r convert_mouse_gene_to_human_gene}
...
ggsave(DimPlot(rareall, group.by = "celltype", reduction = "umap") + scale_color_manual("", values = brewer.pal(6, "Set1")), filename = "umap_celltype.pdf", width=7, height=6)
